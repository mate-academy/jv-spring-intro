...
public class AppConfig {
    ...
    public LocalSessionFactoryBean getSessionFactory() {
        ...
        properties.put("hibernate.hbm2_ddl.auto", environment.getProperty("hibernate.hb2ddl.auto"));
        localSessionFactoryBean.setHibernateProperties(properties);
        localSessionFactoryBean.setPackagesToScan("mate.academy.spring.domain");
