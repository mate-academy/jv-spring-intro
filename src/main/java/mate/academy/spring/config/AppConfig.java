...
public class AppConfig {
    ...
    public LocalSessionFactoryBean getSessionFactory() {
        ...
        property.put("show_sql", environment.getProperty("db.hibernate.show_sql"));
        property.put("hibernate.hbm2ddl.auto", environment
                .getProperty("db.hibernate.hbm2ddl.auto"));
